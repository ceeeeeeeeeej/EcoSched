...
class AppTheme {
  ...
  static ThemeData get darkTheme => ThemeData(
        ...
        appBarTheme: AppBarTheme(
          elevation: 0,
          centerTitle: true,
          backgroundColor: AppPalette.neutral900.withOpacity(0.8),
          foregroundColor: textInverse,
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          hintStyle: bodyMedium.copyWith(color: textInverse.withOpacity(0.5)),
          errorStyle: bodySmall.copyWith(color: error),
          prefixIconColor: textInverse.withOpacity(0.6),
          suffixIconColor: textInverse.withOpacity(0.6),
        ),
