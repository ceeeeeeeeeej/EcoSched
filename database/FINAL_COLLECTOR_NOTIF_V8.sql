-- =================================================================
-- REVISED CONSOLIDATED NOTIFICATION FIX FOR COLLECTORS (V8)
-- Removed non-existent 'profiles' table reference.
-- Uses 'users' and 'registered_collectors'.
-- =================================================================
...
-- Clears "New Pickup Request" and also "Collection Started" (as requested earlier to remove unwanted ones)
