...
class Translations {
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'authorized_personnel_only': 'Authorized personnel only. Please sign in to access your dashboard.',
    ...
    'ceb': {
      ...
      'victoria': 'Victoria',
      'dayo_an': 'Dayo-an',
      'access_schedules_victoria': 'Pag-access sa lokal nga mga iskedyul para sa Victoria',
      'access_schedules_dayo_an': 'Pag-access sa lokal nga mga iskedyul para sa Dayo-an',
      'dashboard': 'Dashboard',
      'profile': 'Profile',
      'settings': 'Settings',
      ...
      'zone': 'Sona',
      'review_schedules': 'Ribyuha ang mga iskedyul ug sunda ang mga protocol sa kaluwasan.',
      'collector_dashboard': 'Dashboard sa Kolektor',
      'live_scan': 'Live Scan',
      'switch_light_mode': 'Ibalhin sa light mode',
      'switch_dark_mode': 'Ibalhin sa dark mode',
      'route_started_updated': 'Nagsugod na ang rota! {} ka koleksyon ang na-update.',
      'route_started_notifs': 'Nagsugod na ang rota! gipadala ang mga notipikasyon.',
      'home': 'Balay',
      'feedback': 'Feedback',
      'scan': 'I-scan',
      'special': 'Espesyal',
      ...
      'no_notifications': 'Hapsay ang tanan! Walay mga notipikasyon niining panahona.',
      'collector_access': 'Collector Access',
      'welcome_back': 'Maayong Pagbalik',
      'authorized_personnel_only': 'Para lamang sa awtorisadong personahe. Palihog pag-sign in aron maka-access sa imong dashboard.',
  ...
  static String translateStatic(String key, {String locale = 'ceb', List<String>? args}) {
  ...
  static String getBilingualText(String englishText) {
    ...
    if (englishText.contains('Tomorrow')) {
      return '$englishText\n(Koleksyon Ugma!)';
    }
    if (englishText.contains('Soon')) {
      return '$englishText\n(Ang trak moabot na sa dili madugay!)';
    }
    if (englishText.contains('Get ready!')) {
      return '$englishText\n(Pangandam! Adunay koleksyon sa basura.)';
    }
    if (englishText.contains('Pickup Request')) {
      return '$englishText\n(Adunay Bag-ong Gihangyo nga Pagkuha.)';
    }
...
extension TranslationExtension on BuildContext {
  String tr(String key, {List<String>? args}) {
    // 🛡️ FIX: Use listen: false to prevent crashes when called from event handlers (like login buttons)
    final locale = LanguageProvider.of(this, listen: false).currentLocale;
